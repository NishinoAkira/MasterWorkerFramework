...
public class Worker {
	...
	public Worker(String masterIP, TaskExecutorFactory executorFactory) {
	...
	public final void startWork() throws IOException {
		...
		heartBeat = new WorkerHB(masterIP, id, context.socket(ZMQ.REQ), this);
		heartBeat.start();
